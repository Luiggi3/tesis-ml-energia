...
LAG_LABEL     = '15 Minutes'            # equivalencia de 1 lag, para gráficos en eje 'Time Lag'
HORIZON       = 672                     # pasos hacia adelante = 7 días (1 semana) a resolución 15 min
HORIZON_LABEL = '7 Días (1 Semana)'
LAGS_GAP      = [1, 2, 4, 8, 12, 96, 672]   # 96 = 24h; 672 = 7 días (lag semanal)
ROLL_WINDOWS  = [4, 8, 96, 672]
TRAIN_RATIO   = 0.80
TRAIN_WINDOW  = 15_000                  # ventana de entrenamiento unificada (RF, XGB y SVR)
